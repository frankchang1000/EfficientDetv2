...
def draw_boxes(image: tf.Tensor,
    ...
    code_colors = {'pet': (0, 255, 0), 'hdpe': (0, 191, 0), 'pvc': (0, 127, 0), 'ldpe': (255, 255, 0), 
                'pp': (255, 191, 0), 'ps': (255, 127, 0), 'other': (255, 0, 0), 'metal': (0, 0, 255), 'paper': (0, 0, 255), 'glass': (0, 0, 255), 'cardboard': (0, 0, 255)}


    color_indices = {label: i for i, label in enumerate(labels_dict)}

    color_palette = {label: code_colors.get(label, (0, 0, 0)) for label in labels_dict}
